...
import { getReportById } from "../../../backend/services/firestoreService";
...
export default function HistoryDetailsScreen({ navigation, route }) {
  ...
  const formattedDate = scan?.date?.toDate
    ? scan.date.toDate().toLocaleString("en-US", {
    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
          <Text style={{ color: "#5B8BB0" }}>Report not found.</Text>
        </View>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.imageContainer}>
          {scan.photoURL ? (
            <Image source={{ uri: scan.photoURL }} style={styles.image} resizeMode="cover" />
          ) : (
        ...
        <View style={styles.severityCard}>
          ...
          <View style={styles.severityContent}>
            ...
            <Text style={[styles.severityValue, { color: severityColor }]}>{scan.severity}</Text>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={[styles.detailRow, styles.notesRow]}>
            ...
            <Text style={[styles.detailValue, styles.notesText]}>{scan.notes || "No notes added."}</Text>
          </View>
        </View>
      </ScrollView>
